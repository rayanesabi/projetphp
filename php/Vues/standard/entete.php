...
<nav class="navbar">
    <ul>
        ...
        <li><a>
                <form method="get" action="../php/index.php?url=Recherche" id ="formi" >
                    <input type="text" name="saisie" placeholder="Rechercher...">
                    <input type="hidden" name="url" value="Recherche" id="url">
                    <input type="submit" value="Rechercher" class="go"  form ="formi" id="boutonn">
                </form>
            </a></li>
        <li><a id="accueil" href="../php/index.php">ACCUEIL</a></li>
        <li><a id="connex" href="../php/index.php?url=Compte">CONNEXION </a></li>
        <li>|</li>
