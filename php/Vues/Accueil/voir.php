...
<div id="categories">
    ...
    <button><img id="chocolat" src="Vues/images/chocolate.png" onclick="window.location.href='../php/index.php?url=Recette/trierIngredients/chocolat'">Au chocolat</button>
    <button><img id="particularite" src="Vues/images/vegan.png" onclick="window.location.href='../php/index.php?url=Recette/trierParticularite/végan'">Vegan</button>
